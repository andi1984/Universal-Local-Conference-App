...
#define SHKMyAppName			@"ShareKitTestApplication"
#define SHKMyAppURL				@"http://twitter.com/andi1984"
 ...
 */
#define SHKTwitterConsumerKey		@"ULwZyO0jwYm0QwNlivoYA"
#define SHKTwitterSecret			@"B4S4Tjjb4cAJ0qgy7df28v4t6t8CxPxsEuEZcjkmgI"
#define SHKTwitterCallbackUrl		@"http://twitter.com/andi1984" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"andi1094" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
